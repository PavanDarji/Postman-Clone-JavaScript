...
function getElementFromsString(string) {
...
let parammetersBox = document.getElementById('parametersBox');
parammetersBox.style.display = 'none';


//user click params box
...
addParam.addEventListener('click', () => {
    ...
    let paramElement = getElementFromsString(string);
